...
int getTypeInThumb16(uint16_t instruction)
{
...
int getTypeInThumb32(uint32_t instruction)
{
...
int getTypeInArm(uint32_t instruction)
{
...
int relocateInstructionInThumb16(uint32_t pc, uint16_t instruction, uint16_t *trampoline_instructions)
{
	int type;
	int offset;
...
int relocateInstructionInThumb32(uint32_t pc, uint16_t high_instruction, uint16_t low_instruction, uint16_t *trampoline_instructions)
{
